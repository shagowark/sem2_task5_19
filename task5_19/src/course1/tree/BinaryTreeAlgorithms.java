...
public class BinaryTreeAlgorithms {
    ...
    свой метод
     */
    public static <T> boolean compareTrees(BinaryTree.TreeNode<T> treeNode1, BinaryTree.TreeNode<T> treeNode2){
        ...
        while (stack1.size() > 0){
            ...
            BinaryTree.TreeNode<T> node1 = stack1.pop();
            BinaryTree.TreeNode<T> node2 = stack2.pop();
