...
public class TreeDemoFrame extends JFrame {
    ...
    private JButton buttonSaveFirstTree;
    private JButton buttonSaveSecondTree;
    private JButton buttonCompareTrees;
    ...
    BinaryTree<Integer> treeToCompare1 = new SimpleBinaryTree<>();
    BinaryTree<Integer> treeToCompare2 = new SimpleBinaryTree<>();
    ...
    public TreeDemoFrame() {
        ...
        buttonSaveFirstTree.addActionListener(actionEvent -> {
            try {
        ...
        buttonSaveSecondTree.addActionListener(actionEvent -> {
            try {
                SimpleBinaryTree<Integer> tree = new SimpleBinaryTree<>(Integer::parseInt);
                tree.fromBracketNotation(textFieldBracketNotationTree.getText());
                this.treeToCompare2 = tree;
                repaintTree();
            } catch (Exception ex) {
                SwingUtils.showErrorMessageBox(ex);
            }
        ...
        buttonCompareTrees.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                try {
                    boolean result = BinaryTreeAlgorithms.compareTrees(treeToCompare1.getRoot(), treeToCompare2.getRoot());
                    if (result) {
            ...
            try {
                BinaryTreeAlgorithms.compareTrees(treeToCompare1.getRoot(), treeToCompare2.getRoot());
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        buttonSaveSecondTree = new JButton();
        buttonSaveSecondTree.setText("Сохранить второе дерево");
        panel7.add(buttonSaveSecondTree, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        buttonSaveFirstTree = new JButton();
        buttonSaveFirstTree.setText("Сохранить первое дерево");
        panel7.add(buttonSaveFirstTree, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        buttonCompareTrees = new JButton();
        buttonCompareTrees.setText("Сравнить деревья");
        panel8.add(buttonCompareTrees, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
    }
